...
public:
    ...
    int apply_decorrelation(int32_t* data_c1, int32_t* data_c2, int len);

private:
    void apply_mode(int mode, const int32_t* src1, const int32_t* src2, int32_t* dst1, int32_t* dst2, int len);
};
