#ifndef TAK_DECO_LIB_H
#define TAK_DECO_LIB_H
#ifdef __cplusplus
extern "C" {
#endif

#if defined(_WIN32)
  #if defined(TAK_DECO_LIB_EXPORTS)
...
// Portability types for non-Windows
#ifndef _MSC_VER
#include <stdint.h>
typedef int32_t      TtakInt32;
typedef uint32_t     TtakUInt32;
typedef int64_t      TtakInt64;
typedef int32_t      TtakBool;
